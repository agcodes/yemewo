    ...
    <div class="col-12 col-md-9">
      ...
      <div v-if="!game.isLoading" class="card border-0 mb-5 p-3">
        <div class="card-body">
          ...
          >
            <div
              v-for="(letter, index) in game.wordToGuess"
              :key="index"
                ...
                {{
                  game.wordFound
                    ...
                    : game.wordToGuess[index] === '-' && !game.userGuess[index]
                      ...
                      : game.userGuess[index]
                        ? game.userGuess[index].toUpperCase()
                        : ''
                }}
              </span>
            </div>
          ...
          <div class="d-flex justify-content-center align-items-center gap-2 mb-3">
            <div class="hidden" style="max-width: 300px">
              <input
                ...
                :maxlength="game.wordToGuess.length"
                :disabled="game.isLoading"
                @input="game.checkGuessOnInput"
...
import { extractSvgElements, drawSvgElement } from '@/composables/useSvgDrawing'
...
async function initSvg() {
  const containerEl: HTMLElement | null = document.getElementById('container')
  ...
  if (previousSvgId) {
    const oldSvg: HTMLElement | null = document.getElementById(previousSvgId)
    if (oldSvg) {
